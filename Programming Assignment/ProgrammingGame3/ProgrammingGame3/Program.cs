...
namespace ProgrammingGame
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (CreateNPC == "create npc")
            {
                ...
                NPC npc1 = new NPC("MONSTER", "HAS LARGE FANGS", new TwoDPoint(10, 20), 5, npc1Name, "UNKNOWN");

                //npc 2
                Console.WriteLine("What would you like to call npc2?");
                string npc2Name = Console.ReadLine();
                NPC npc2 = new NPC("MONSTER", "HAS A TERRIBLE STENCH", new TwoDPoint(30, 80), 5, npc2Name, "UNKNOWN");

                //npc3
                Console.WriteLine("What would you like to call npc3?");
                string npc3Name = Console.ReadLine();
                NPC npc3 = new NPC("ALIEN", "HAS LOVELY SHOES", new TwoDPoint(50, 50), 5, npc3Name, "UNKNOWN");
    ...
    public class NPC
    {
        ...
        public void printStatus()
        {
            Console.WriteLine("{4} is a {0} and is at {2},{3} position. {4}'s alliegiance status is {5}", npcType, npcBackstory, npcPosition.x, npcPosition.y, npcName, npcStatus);
        }
